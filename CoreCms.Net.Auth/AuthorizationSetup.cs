 ...
 *           Versions: 1.0                                             *
 *         CreateTime: 2020-02-02 22:08:00
 *          NameSpace: CoreCms.Net.Framework.Auth
 *           FileName: AuthorizationSetup
 *   ClassDescription: 
 ***********************************************************************/
...
namespace CoreCms.Net.Auth
{
    ...
    public static class AuthorizationSetup
    {
        ...
        public static void AddAuthorizationSetupForAdmin(this IServiceCollection services)
        {
            ...
            #region 参数
            //读取配置文件
            var symmetricKeyAsBase64 = AppSettingsHelper.GetContent("JwtConfig", "SecretKey");
            var keyByteArray = Encoding.ASCII.GetBytes(symmetricKeyAsBase64);
            var signingKey = new SymmetricSecurityKey(keyByteArray);
            var issuer = AppSettingsHelper.GetContent("JwtConfig", "Issuer");
            var audience = AppSettingsHelper.GetContent("JwtConfig", "Audience");
