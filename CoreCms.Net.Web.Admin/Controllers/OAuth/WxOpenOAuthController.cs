...
using CoreCms.Net.WeChatService;
...
namespace CoreCms.Net.Web.WebApi.Controllers.OAuth
{
    /// <summary>
    /// 微信小程序请求对接Controller
    /// </summary>
    [Route("[controller]/[action]")]
    public partial class WxOpenOAuthController : Controller
    {
        /// <summary>
        ...
        public WxOpenOAuthController(ICoreCmsUserWeChatInfoServices userWeChatInfoServices)
        {
