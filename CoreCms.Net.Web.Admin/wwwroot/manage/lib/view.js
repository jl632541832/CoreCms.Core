        ...
        i.loading =
            ...
            i.req = function (e) {
                var a = e.success,
                    ...
                    o = r.request,
                    s = r.response,
                    d = function () { return r.debug ? "<br><cite>URL：</cite>" + e.url : "" };
                if (e.data = e.data || {}, e.headers = e.headers || {}, o.tokenName) {
                    var l = "string" == typeof e.data ? JSON.parse(e.data) : e.data;
                    //e.data[o.tokenName] =
                    //    o.tokenName in l ? e.data[o.tokenName] : layui.data(r.tableName)[o.tokenName] || "", e.headers[
                    //    o.tokenName] = o.tokenName in e.headers
                    //        ? e.headers[o.tokenName]
                    //        : layui.data(r.tableName)[o.tokenName] || ""

                    e.data[o.tokenName] =
                        o.tokenName in l ? e.data[o.tokenName] : layui.data(r.tableName)[o.tokenName] || "";
                    if (o.tokenName === 'Authorization') {
                        e.headers[o.tokenName] = 'Bearer ' + layui.data(r.tableName)[o.tokenName];
                    } else {
                        e.headers[o.tokenName] = o.tokenName in e.headers
                            ? e.headers[o.tokenName]
                            : layui.data(r.tableName)[o.tokenName] || "";
                    }
                ...
                return delete e.success, delete e.skin, n.open(t.extend({
                    ...
                    success: function (e, r) {
                        ...
                        e.append(o), o.on("click", function () { n.close(r) }), "function" == typeof a &&
            ...
            function (e, a) {
                return i.popup(t.extend({ content: e, maxWidth: 300, offset: "t", anim: 6, id: "LAY_adminError" },
                    a))
            }, d.prototype.render = function (e, a) {
                var n = this;
                layui.router();
                return e =
                    r.views + e + r.engine, t("#" + s).children(".layadmin-loading").remove(), i.loading(n.container),
                    t.ajax({
                        url: e,
                        type: "get",
                        dataType: "html",
                        ...
                        success: function (e) {
                            ...
                            var r = t(e).find("title"),
                                ...
                                s = { title: o, body: e };
                            r.remove(), n.params =
                                a || {}, n.then && (n.then(s), delete n.then), n.parse(e), i.removeLoad(), n.done &&
                                (n.done(s), delete n.done)
                        },
                        error: function (e) {
                            return i.removeLoad(), n.render.isError
                                ? i.error("请求视图文件异常，状态：" + e.status)
                                : (404 === e.status ? n.render("template/tips/404") : n.render("template/tips/error"), void (
                                    n.render
                                        .isError = !0))
                        }
                    }), n
                    ...
                    !function () {
                        ...
                        n
                            ? i.req({
                                ...
                                dataType: "json",
                                headers: s,
                                success: function (a) { c({ dataElem: e, res: a, done: t }) }
                            })
                            : c({ dataElem: e, done: t })
                    }();
                return s
            ...
            }, d.prototype.then = function (e) { return this.then = e, this }, d.prototype.done =
