var allWidget = {
    ...
    },
    {
        ...
        "value": {
            ...
            "list": [
                {
                    "goodsImage": "/images/empty-banner.png",
                    "name": '',
                    "price": ''
                },
                {
    ...
    },
    {
        ...
        "value": {
            ...
            "list": [
                {
                    "thumbnail": "/images/empty-banner.png",
                    "title": '',
                    "money": ''
                },
                {
    ...
    mounted() {
        ...
        layui.use(['admin', 'coreHelper'],
            function () {
                ...
                if (id) {
                    coreHelper.Post("Api/CoreCmsPages/GetPageData",
                        { id: id },
                        function (e) {
                            if (e.code === 0) {
...
Vue.component('layout-config', {
    ...
    mounted() {
        ...
        layui.use(['admin', 'coreHelper', 'treeTable'],
            function () {
                ...
                var id = test.split("?id=")[1];
                if (id) {
                    coreHelper.Post("Api/CoreCmsPages/GetEdit", { id: id }, function (e) {
                        if (e.code === 0) {
                            //console.log(e);
    ...
    methods: {
        ...
        upImage: function (index, item) {
            ...
            //console.log(index);
            //console.log(item);
            //console.log(_that.selectWg.value.list[index]);
                    ...
                    function () {
                        ...
                        form.on('submit(LAY-app-CoreCmsPages-EditForm-submit)',
                            function (data) {
                                ...
                                coreHelper.Post("Api/CoreCmsPages/DoEdit", { pageCode: pageCode, datalist: datalist }, function (e) {
                                    console.log(e)
                                    if (e.code === 0) {
                                        layer.msg(e.msg);
                                    } else {
