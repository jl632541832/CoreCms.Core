...
namespace CoreCms.Net.Middlewares
{
    ...
    public class ExceptionHandlerMiddForClent
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception ex)
        {
            ...
            NLogUtil.WriteFileLog(NLog.LogLevel.Error, LogType.ApiRequest, "全局捕获异常", new Exception("全局捕获异常", ex));
            NLogUtil.WriteDbLog(NLog.LogLevel.Error, LogType.ApiRequest, "全局捕获异常", new Exception("全局捕获异常", ex));
