 ...
 *         CreateTime: 2020-08-30 16:53:41
 *        Description: 暂无
 ***********************************************************************/
...
namespace CoreCms.Net.Model.ViewModels.Echarts
{
    ...
    public class EchartsOption
    {
        ...
        /// 标题组件，包含主标题和副标题。
        /// </summary>
        public Title title { get; set; } = new Title() { text = "报表" };
        /// <summary>
        /// 提示框组件
        /// </summary>
        public Tooltip tooltip { get; set; } = new Tooltip() { trigger = "axis" };
        /// <summary>
        /// 图例组件
        /// </summary>
        ...
        /// 直角坐标系内绘图网格
        /// </summary>
        public Grid grid { get; set; } = new Grid() { left = "3%", right = "4%", bottom = "3%", containLabel = true };
        /// <summary>
        /// 工具栏
        /// </summary>
        public Toolbox toolbox { get; set; } = new Toolbox() { feature = new Feature() { saveAsImage = new List<string>() } };
        /// <summary>
        /// 直角坐标系 grid 中的 x 轴
        /// </summary>
        public XAxis xAxis { get; set; } = new XAxis() { type = "category", boundaryGap = false, data = new List<string>() };
        /// <summary>
        /// 直角坐标系 grid 中的 y 轴
        /// </summary>
        public YAxis yAxis { get; set; } = new YAxis() { type = "value", name = "元" };
        /// <summary>
        /// 系列列表
        /// </summary>
